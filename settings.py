...
BLAST_GASPRICE_PRESCALE = 0.0001                    # Использовать Max base fee и Priority fee для газа в Blast
...
VALUE_SWAP = [0.0000001, 0.000001, 7]                        # [min, max, decimal]
...
#           'swap'                                  - Покупка + продажа на юнисвап
